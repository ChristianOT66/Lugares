...
class UpdateLugarFragment : Fragment() {
    ...
    private fun escribirCorreo() {
        ...
        } else { //Si está vació entonces mostrar un error
            Toast.makeText(
                requireContext(),
    ...
    private fun llamarLugar() {
        ...
        if (valor.isNotEmpty()) {   //Si tiene algo se puede intentar llamar
            ...
            if (requireActivity()
                ...
                //Si estamos acá hay que pedir autorización para hacer la llamada
    ...
    private fun verMapa() {
        ...
        if (latitud.isFinite() && longitud.isFinite()) { //Si tiene tiene coordenadas validas se muestra el mapa
    ...
    private fun deleteLugar() {
        ...
        alerta.setMessage(getString(R.string.msg_pregunta_elininar) + "${args.lugar.nombre}?")
    ...
    private fun updateLugar() {
        ...
        if (nombre.isNotEmpty()) {
            val lugar = Lugar(
                args.lugar.id, nombre, correo, telefono, web,
                args.lugar.latitud,
                args.lugar.longitud,
                args.lugar.altura,
            ...
            Toast.makeText(
                requireContext(), getString(R.string.msg_lugar_updated),
                Toast.LENGTH_SHORT
            ).show()
            findNavController().navigate(R.id.action_updateLugarFragment_to_nav_lugar)
